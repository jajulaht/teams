...
<h1><i class="fas fa-running"></i>Pelipörssi</h1>
...
<?php
    ...
    echo "<span class='points'><a href='points.php'>Pistetaulukko<a/></span>";
    ...
    <div id="container"></div>
      ...
      <script type="text/babel" src="js/react-teams.js"></script>
